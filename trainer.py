...
class RobertaModelTrainer:
    ...
    def _val_step(self, model: RobertaSentimentModel, val: DataLoader, pbar: tqdm) -> Tuple[float, float, float]:
        ...
        print("Macro PRE:", mcm.precision("macro"))
        print("Macro REC:", mcm.recall("macro"))
        print("Macro F1S:", mcm.f1("macro"))
        print("Weighted PRE:", mcm.precision("weighted"))
        print("Weighted REC:", mcm.recall("weighted"))
        print("Weighted F1S:", mcm.f1("weighted"))
        print("PC MCC:", mcm.per_class_mcc())
        print("PC PER:", mcm.per_class_precision())
        print("PC REC:", mcm.per_class_recall())
        print("PC ACC:", mcm.per_class_accuracy())
        print(mcm)
